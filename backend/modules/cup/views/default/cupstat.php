...
<div class='middle_team'>
    ...
    <input id="hteam" type="hidden" name="homeTeam" value="<?=$match->homeTeam?>">
    <input id="gteam" type="hidden" name="guestTeam" value="<?=$match->guestTeam?>">
    <div class='regHeadTeam'>Визначення результату матча</div>
    <div class="rezulInfo">
        <div class="goals">
            <div class="hgoals">
                <div class="scores">
                    <div class='scoreTeamName'><?= $match->homeTeam ?></div>
                    <br>
                    <label>
            ...
            <div class="ggoals">
                <div class="scores">
                    <div class='scoreTeamName'><?= $match->guestTeam ?></div>
                    <br>
